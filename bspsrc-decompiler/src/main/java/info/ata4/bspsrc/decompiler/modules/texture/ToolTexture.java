...
public final class ToolTexture {
    ...
    public static final String CLIP_CONCRETE = "tools/toolsclip_concrete";
    public static final String CLIP_DIRT = "tools/toolsclip_dirt";
    public static final String CLIP_GLASS = "tools/toolsclip_glass";
    public static final String CLIP_GRASS = "tools/toolsclip_grass";
    public static final String CLIP_GRAVEL = "tools/toolsclip_gravel";
    public static final String CLIP_METAL = "tools/toolsclip_metal";
    public static final String CLIP_METAL_SAND_BARREL = "tools/toolsclip_metal_sand_barrel";
    public static final String CLIP_METALGRATE = "tools/toolsclip_metalgrate";
    public static final String CLIP_METALVEHICEL = "tools/toolsclip_metalvehicle";
    public static final String CLIP_PLASTIC = "tools/toolsclip_plastic";
    public static final String CLIP_RUBBER = "tools/toolsclip_rubber";
    public static final String CLIP_RUBBERTIRE = "tools/toolsclip_rubbertire";
    public static final String CLIP_SAND = "tools/toolsclip_sand";
    public static final String CLIP_SNOW = "tools/toolsclip_snow";
    public static final String CLIP_TILE = "tools/toolsclip_tile";
    public static final String CLIP_WOOD = "tools/toolsclip_wood";
    public static final String CLIP_WOOD_BASKET = "tools/toolsclip_wood_basket";
    public static final String CLIP_WOOD_CRATE = "tools/toolsclip_wood_crate";

    public static final String NODRAW_METAL = "tools/toolsnodraw_metal";
    
    public static final String INVISMETAL = "tools/invismetal";

    public static final String CLIMB = "tools/climb";
}
